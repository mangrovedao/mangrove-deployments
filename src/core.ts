...
export const getMangroveVersionDeployments = (filter?: DeploymentFilter): VersionDeployments | undefined => {
...
export const getMgvOracleVersionDeployments = (filter?: DeploymentFilter): VersionDeployments | undefined => {
...
export const getMgvReaderVersionDeployments = (filter?: DeploymentFilter): VersionDeployments | undefined => {
