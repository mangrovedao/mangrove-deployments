...
export const _testErc20Deployments: VersionDeployments[] = [
  DAI_v1_5_6, USDC_v1_5_6, WETH_v1_5_6, USDT_v1_5_3, WBTC_v1_5_3, WMATIC_v1_5_3, PxMATIC_v1_3_0, PxUSDC_v1_3_0
];

export const getTestErc20VersionDeployments = (filter?: DeploymentFilter): VersionDeployments | undefined => {
  return findDeployment(filter, _testErc20Deployments);
}

export const getAllTestErc20VersionDeployments = (filter?: DeploymentFilter): VersionDeployments[] => {
